...
namespace JisSDKAds.Editor.Tools
{
    /// <summary>
    ...
    public class SceneBootstrapper
    {
        ...
        private const string k_LoadBootstrapMenu = "Tools/Bootstrap Scene/Load Bootstrap Scene On Play";
        private const string k_DontLoadBootstrapMenu = "Tools/Bootstrap Scene/Don't Load Bootstrap Scene On Play";
